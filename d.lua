...
local extra = aimbotTab:createGroup('center', 'Extra')
local Other = aimbotTab:createGroup('right', 'Other')

local ragebot = ragetab:createGroup('left', 'Rage bot')
local extra = ragetab:createGroup('center', 'Extra')
local Other = ragetab:createGroup('right', 'Other')

local esp = visualsTab:createGroup('left', 'Esp')
local extra = visualsTab:createGroup('center', 'Settings')
local Other = visualsTab:createGroup('right', 'Colors')

local mainmisc = miscTab:createGroup('left', 'Misc')
local world = miscTab:createGroup('center', 'World Editor')
local Fun = miscTab:createGroup('right', 'Fun')
